...
rewrite_profile_for_protocol "/mnt/c/BigFiles/Github/auto-openvpn-static-ip/tmp-route-qa/source.ovpn" "/mnt/c/BigFiles/Github/auto-openvpn-static-ip/tmp-route-qa/windows.ovpn" "/mnt/c/BigFiles/Github/auto-openvpn-static-ip/tmp-route-qa/server-udp.conf" "/mnt/c/BigFiles/Github/auto-openvpn-static-ip/tmp-route-qa/server-tcp.conf"
